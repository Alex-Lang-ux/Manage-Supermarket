...
namespace QuanLySieuThi
{
    ...
    {
        public string chuoi = "select * from tknhanvien";
        public tknhanvien()
        {
            InitializeComponent();
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    string select = "select count(*) from tknhanvien where tk='" + txt_tk.Text + "'";
                    string them1 = "insert into tknhanvien Values ('" + txt_tk.Text + "','" + txt_mk.Text + "')";
        ...
        {
            string sql = "Update tknhanvien set mk ='" + txt_mk.Text + "' where tk = '" + txt_tk.Text + "'";
        ...
        {
            string duongdan = "C:\\Demo\\SupermarketManagement-main\\excel\\taikhoan";
            string tenfile = "tknhanvien";
