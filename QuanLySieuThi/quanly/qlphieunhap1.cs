...
{
    public partial class qlphieunhap1 : Form
    {
        public string chuoi = "Select * from phieunhap1";
        public string chuoi1 = "Select masp,tensp,gianhap ,solg,donvitinh from sanpham";
        ...
        public void tenbang()
        {
            ...
            dta2.Columns[2].HeaderText = "Giá nhập"; dta1.Columns[2].Width = 110;
            ...
            dta1.Columns[0].HeaderText = "Mã phiếu nhập"; dta1.Columns[0].Width = 110;
            dta1.Columns[1].HeaderText = "Mã nhà cung cấp"; dta1.Columns[1].Width = 150;
            dta1.Columns[2].HeaderText = "Mã sản phảm"; dta1.Columns[2].Width = 110;
            ...
            dta1.Columns[5].HeaderText = "Giá nhập"; dta1.Columns[5].Width = 110;
            dta1.Columns[6].HeaderText = "Nhân viên nhận"; dta1.Columns[6].Width = 110;
            dta1.Columns[7].HeaderText = "Ngày nhập"; dta1.Columns[7].Width = 110;
        ...
        private void bnt_sua_Click(object sender, EventArgs e)
        {
            ...
            d = int.Parse(txt_gianhap.Text.ToString());
            key = c * d;
            string sql = "Update phieunhap1 set mancc = '" + txt_mancc.SelectedValue + "',masp = '" + txt_mathuoc.Text + "',solg = N'" + txt_solg.Text + "',donvitinh = N'" + txt_dvt.Text + "',gianhap = '" + txt_gianhap.Text + "',nvnhap=N'" + txt_tennv.Text + "',ngaynhap = '" + txt_ngaynhap.Value + "',thanhtien = '" + key.ToString() + "',congno = N'" + txt_congno.Text + "' where mahdn = '" + txt_mhd.Text + "'";
        ...
        {
            string sql = "Delete from phieunhap1 where mahdn = '" + txt_mhd.Text + "'";
        ...
        {
            string load1 = "Select masp,tensp,gianhap ,solg,donvitinh from sanpham where tensp like N'%" + txt_search.Text + "%' ";
